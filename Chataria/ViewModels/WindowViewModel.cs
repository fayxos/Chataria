...
namespace Chataria
{
    ...
    public class WindowViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// The biggest width the window can go to
        /// </summary>
        public double WindowMaximumWidth { get; set; } = SystemParameters.WorkArea.Width;

        /// <summary>
        /// The biggest height the window can go to
        /// </summary>
        public double WindowMaximumHeight { get; set; } = SystemParameters.WorkArea.Height;
        ...
        /// </summary>
        public bool Borderless => mWindow.WindowState == WindowState.Maximized || mDockPosition != WindowDockPosition.Undocked ? true : false;
